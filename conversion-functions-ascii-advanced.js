...
function binaryToHexadecimal(blob) {
  let decimalVal = parseInt(blob.substring(2), 2);
  return "0x" + decimalVal.toString(16);
}

/* Base 16 to base 2 */
function hexadecimalToBinary(blob) {
  let decimalVal = parseInt(blob.substring(2), 16);
  return "0b" + decimalVal.toString(2);
}
